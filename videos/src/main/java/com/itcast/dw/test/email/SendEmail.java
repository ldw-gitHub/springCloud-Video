...
public class SendEmail {
	...
	public static void main(String[] args) throws Exception {
        ...
        //    真正要发送时, 邮箱必须是真实有效的邮箱。
        message.setFrom(new InternetAddress("dawei.liu@wayhe.com", "wayhe", "UTF-8"));
 
        // 3. To: 收件人
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress("992194916@qq.com", "USER_CC", "UTF-8"));
        //    To: 增加收件人（可选）

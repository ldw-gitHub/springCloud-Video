...
public class ToSendEmail {
    ...
    public static String myEmailAccount = "992194916@qq.com";
    public static String myEmailPassword = "nhbhqaypkttpbdjh";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "455937110@qq.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "wayhe", "UTF-8"));

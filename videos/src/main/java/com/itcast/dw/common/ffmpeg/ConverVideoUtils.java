package com.itcast.dw.common.ffmpeg;
...
public class ConverVideoUtils {
	...
	public boolean beginConver(String targetExtension, boolean isDelSourseFile) {
		...
		if (process(targetExtension, isDelSourseFile)) {
			 ...
			 * System.out.println("删除原文件-可用："+sourceVideoPath); file1.delete();
			 * }
			 */
	 ...
	 * System.out.println("视频文件不存在============="+path); return true; } else {
	 * System.out.println("视频文件存在"+path); return false; } } catch (Exception e)
	 * { // TODO: handle exception System.out.println("拒绝对文件进行读访问"); } return
	 * false; }
	 */
